...
async def create_profile(
    ...
    try:
        return ProfileService.create_profile(user=current_user_id, last_name=last_name, name=name, gender=gender, age=age, photo=photo_data, remark=remark, db=db)
    except HTTPException as e:
        raise HTTPException(status_code=e.status_code, detail=e.detail)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def update_profile(
    ...
    try:
        return ProfileService.update_profile(user=current_user_id, last_name=last_name, name=name, gender=gender, age=age, photo=photo, remark=remark, db=db)
    except HTTPException as e:
        raise HTTPException(status_code=e.status_code, detail=e.detail)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
