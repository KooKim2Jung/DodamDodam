...
import Guardian from '../../guardians/Guardian/Guardian';
                ...
                <div className='absolute right-10 flex items-center'>
                    {isLoggedIn ? (<>
                        <div className='flex items-center wave'>
                            ...
                            <a className='block lg:hidden relative mr-4 pb-1 cursor-pointer' onClick={handletGuardian}><FiToggleRight size='30' /></a>
