...
const abouts = [
    ...
    {
        title: "스케줄링",
        description: "스케줄을 설정하면 시간에 맞춰 알려줘요.",
    ...
    {
        title: "피보호자 설정",
        description: "피보호자의 정보를 입력해서 맞춤형 서비스를 받아보세요.",
        ...
        <div className='flex flex-col justify-center items-center h-screen pt-[60px] md:pt-[100px] w-screen'>
                    ...
                    <div key={index}>
                        <div className='w-[20vh] md:w-[50vh] lg:w-[24vh] md:flex md:items-center lg:grid'>
                            <div className='relative z-0'>
                                ...
                                <img className='h-[9vh] w-[9vh] md:h-[10vh] md:w-[10vh] mt-[2vh] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' src={about.icon} alt='기능별 사진'/>
                            </div>
            ...
            <div className='grid grid-cols-3 gap-10 md:gap-28 transition-all duration-300'>
                {abouts.slice(2,5).map((about, index) => (
                    <div key={index}>
                        <div className='w-[21vh] md:w-[24vh]'>
                            <div className='relative'>
                                <img className='h-[20vh] w-[20vh] md:h-[24vh] md:w-[24vh]' src='./images/star.png' alt='노란색 별'/>
                                <img className='h-[9vh] w-[9vh] md:h-[10vh] md:w-[10vh] mt-[1vh] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' src={about.icon} alt='기능별 사진'/>
                            </div>
                            <div className='relative -mt-[2vh] md:-mt-[4vh] z-1'>
                                <div className='text-[4vh]'>{about.title}</div>
                                <div className='text-[3vh] hidden md:block'>{about.description}</div>
                            </div>
                        </div>
                    </div>
