    ...
    return (
        <div>{voices.map((voices) => (
            <label key={voices.name}>
                <input className='ml-8 mr-3 radio-box checked:bg-secondary border-white shadow-custom1'
                    type='radio' 
                    value={voices.name} 
            ...
            <p className='relative top-6 bg-red-30'>
                <div className='inline-flex items-center'>
                    ...
                    className='relative -left-3 w-0 h-0 border-t-[20px] border-t-transparent hover:scale-110 hover:cursor-pointer
                    ...
                    />
                    <input className='input-box2 w-[600px] p-3 mr-2 bg-secondary border-transparent'
                        type='text' 
