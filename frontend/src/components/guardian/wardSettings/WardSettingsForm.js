            ...
            <div className='grid grid-cols-2 absolute top-[190px] left-[350px] text-3xl w-[700px]'>
                ...
                <div className='w-[580px] flex-col'>
                    <div className='flex mb-8'>
                        <input className={`w-28 px-3 py-2 border-2 input-box2 ${isEdit ? 'border-transparent bg-secondary' : 'border-transparent bg-white shadow-[2px_4px_1px_#a5996e]'}`} type='text' name='lastName' value={wardInfo.lastName} readOnly={isEdit===false} onChange={infoUpdate} />
