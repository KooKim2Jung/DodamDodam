        ...
        <div className='flex flex-col h-screen w-screen md:pl-[240px] text-2xl'>
            <div className='pt-20 md:pt-28'>
                ...
                <div className='flex flex-col bg-red-600'>
                    <div className='flex-grow basis-[90%] bg-tertiay rounded-[60px] shadow-[6px_4px_10px_#a5996e] p-7'>
                        <div className='overflow-y-auto h-full w-full'>
                            ...
                            <>{isEditing && currentItemIndex === index ? (
                                <HomeInformationForm
                                    ...
                                    index={index}
                                />) : (
                                <div className='items-center flex justify-center border-transparent bg-white shadow-[2px_4px_1px_#a5996e] rounded-[50px]' 
                                key={index}>
                                    {item.data}
                    ...
                    <div className='flex-grow basis-[10%] bg-blue-800'>
